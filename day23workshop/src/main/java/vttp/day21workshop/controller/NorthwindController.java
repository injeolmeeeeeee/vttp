...
public class NorthwindController {
    ...
    @GetMapping(value = "/total/{order_id}")
    public ResponseEntity<OrderDetails> getOrderTotal(@PathVariable("order_id") String orderId) {
        try {
            OrderDetails orderDetails = northwindRepo.getOrderDetailsByOrderId(orderId);
